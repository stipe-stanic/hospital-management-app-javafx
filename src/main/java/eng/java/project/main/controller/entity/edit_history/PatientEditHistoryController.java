...
public class PatientEditHistoryController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PatientEditHistoryController.class);
    ...
    public void initialize() {
        ...
        entityColumn.setCellValueFactory(data -> {
            ...
            if (afterEditObject instanceof Patient patient) {
